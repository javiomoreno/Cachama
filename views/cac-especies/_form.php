...
<div class="cac-especies-form">
    ...
    <div class="row">
      <div class="page-header">
          ...
          <div class="row">
            <div class="col-md-6">
              <p style="float:left; margin-top: 30px; color: #5CB85C; padding-left: 15px;">Datos de la especie</p>
            </div>
            <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-md-8" style="padding-top: 100px;">
        <div class="row">
          ...
          <div class="col-md-6">
            <?= $form->field($model, 'espenomb')->textInput(['maxlength' => true])->label('Nombre de la Especie <span class="asterisco">*</span>'); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <?= $form->field($model, 'especara')->textarea(array('rows'=>3,'cols'=>5))->label('Características'); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="input-group image-preview">
            ...
            <span class="input-group-btn">
                ...
                <div class="btn btn-default image-preview-input">
                    ...
                    <?= $form->field($model, 'espeimag')->fileInput(['accept'=>'image/*'])->label(false); ?>
                </div>
            </span>
        </div>
      </div>
...
function calcula() {
    ...
    document.getElementById('caccompras-comptota').value = precio * cantidad;
}
</script>
