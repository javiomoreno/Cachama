...
<div class="cac-lagunas-form">
    ...
    <div class="row">
      <div class="page-header">
          ...
          <div class="row">
            <div class="col-md-6">
              <p style="float:left; margin-top: 30px; color: #5CB85C; padding-left: 15px;">Datos del empleado</p>
            </div>
            <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-md-8" style="padding-top: 100px;">
        <div class="row">
          <div class="col-md-6">
            <?= $form->field($model, 'usuanomb')->textInput(['maxlength' => true])->label('Nombre del Empleado <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-6">
            <?= $form->field($model, 'usuaapel')->textInput(['maxlength' => true])->label('Apellido del Empleado <span class="asterisco">*</span>'); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <?= $form->field($model, 'usuacedu')->textInput()->label('Cédula del Empleado <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-4">
            <?= $form->field($model, 'usuatele')->textInput()->label('Teléfono del Empleado <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <?= $form->field($model, 'usuadire')->textInput()->label('Dirección del Empleado <span class="asterisco">*</span>'); ?>
          </div>
        </div>
      </div>
      <div class="col-md-4">
