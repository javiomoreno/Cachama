                    ...
                    <tbody>
                      <?php foreach ($model as $value): ?>
                        <tr class="odd gradeX">
                            ...
                            <td><?= $value->cacTipoUsuariosTiusiden->tiusnomb;?></td>
                            <td style="text-align: center;">
                              <?= Html::a(Html::tag('span', '', ['class' => 'glyphicon glyphicon-eye-open green']).'', ['cac-usuarios/view?id='.$value->usuaiden], '' );?>
                              <?= Html::a(Html::tag('span', '', ['class' => 'glyphicon glyphicon-pencil blue']).'', ['/cac-usuarios/update?id='.$value->usuaiden], '' );?>
                              <?= Html::a(Html::tag('span', '', ['class' => 'glyphicon glyphicon-trash red']).'', ['/cac-usuarios/delete?id='.$value->usuaiden], ['data-method' => 'post'] );?>
                            </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
