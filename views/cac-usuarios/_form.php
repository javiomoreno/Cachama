...
<div class="cac-lagunas-form">
    ...
    <div class="row">
      <div class="col-md-8" style="padding-top: 100px;">
        <div class="row">
          <div class="col-md-6">
            <?= $form->field($model, 'cac_tipoUsuarios_tiusiden')->dropDownList($model->listaTipoUsuarios, ['prompt' => 'Seleccione Tipo de Usuario' ])->label('Tipo de Usuario <span class="asterisco">*</span>');?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <?= $form->field($model, 'usuanomb')->textInput(['maxlength' => true])->label('Nombre del Usuario <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-6">
            <?= $form->field($model, 'usuaapel')->textInput(['maxlength' => true])->label('Apellido del Usuario <span class="asterisco">*</span>'); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <?= $form->field($model, 'usuacedu')->textInput()->label('Cédula del Usuario <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-4">
            <?= $form->field($model, 'usuatele')->textInput()->label('Teléfono del Usuario <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-12">
            <?= $form->field($model, 'usuadire')->textInput()->label('Dirección del Usuario <span class="asterisco">*</span>'); ?>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <?= $form->field($model, 'usuauser')->textInput(['maxlength' => true])->label('Usuario de Conexión <span class="asterisco">*</span>'); ?>
          </div>
          <div class="col-md-6">
            <?= $form->field($model, 'usuapass')->passwordInput(['maxlength' => true])->label('Contraseña <span class="asterisco">*</span>'); ?>
          </div>
        </div>
      </div>
      <div class="col-md-4">
