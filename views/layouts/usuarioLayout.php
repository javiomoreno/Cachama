            ...
            <ul class="nav" id="side-menu">
                <li>
                  ...
                  ?>
                      ...
                      <?php
                        if ($this->params['pestanaUsuario'] > 9 && $this->params['pestanaUsuario'] <= 13) {
                          echo "<li class='active'>";
                    ...
                    <?php
                      if ($this->params['pestanaUsuario'] > 13 && $this->params['pestanaUsuario'] <= 18) {
                        echo "<li class='active'>";
                    ...
                    ?>
                        <?php
                          if ($this->params['pestanaUsuario'] == 14 || $this->params['pestanaUsuario'] == 15 || $this->params['pestanaUsuario'] == 16) {
                            echo "<li class='active'>";
                          }
                          else{
                            echo "<li>";
                        ...
                        ?>
                            ...
                            <ul class="nav nav-third-level">
                                <?php
                                  if ($this->params['pestanaUsuario'] == 14) {
                                    echo "<li class='active'>";
                              ...
                              <li>
                                <?php
                                  if ($this->params['pestanaUsuario'] == 15) {
                              ...
                              <li>
                                <?php
                                  if ($this->params['pestanaUsuario'] == 16) {
                        ...
                        <?php
                          if ($this->params['pestanaUsuario'] == 17 || $this->params['pestanaUsuario'] == 18) {
                            echo "<li class='active'>";
                          }
                          else{
                            echo "<li>";
                        ...
                        ?>
                            ...
                            <ul class="nav nav-third-level">
                                <?php
                                  if ($this->params['pestanaUsuario'] == 17) {
                                    echo "<li class='active'>";
                                ...
                                <?php
                                  if ($this->params['pestanaUsuario'] == 18) {
                                    echo "<li class='active'>";
                        ...
                        <?php
                          if ($this->params['pestanaUsuario'] > 18 && $this->params['pestanaUsuario'] <= 20) {
                            echo "<li class='active'>";
                        ...
                        ?>
                        <?php
                          if ($this->params['pestanaUsuario'] == 19) {
                            echo "<li class='active'>";
                        ...
                        <?php
                          if ($this->params['pestanaUsuario'] == 20) {
                            echo "<li class='active'>";
                    ...
                    <?php
                      if ($this->params['pestanaUsuario'] > 20 && $this->params['pestanaUsuario'] <= 22) {
                        echo "<li class='active'>";
                    ...
                    ?>
                        <?php
                          if ($this->params['pestanaUsuario'] == 21) {
                            echo "<li class='active'>";
                        ...
                        <?php
                          if ($this->params['pestanaUsuario'] == 22) {
                            echo "<li class='active'>";
